    ...
    T: blocking::i2c::WriteRead<Error = E> + blocking::i2c::Read<Error = E> + blocking::i2c::Write<Error = E>,
{
    ...
    async fn write_read<'a>(&'a mut self, address: u8, bytes: &'a [u8], buffer: &'a mut [u8]) -> Result<(), Self::Error> {
    ...
    T: blocking::spi::Transfer<u8, Error = E> + blocking::spi::Write<u8, Error = E>,
{
    ...
    async fn write<'a>(&'a mut self, data: &'a [u8]) -> Result<(), Self::Error> {
    ...
    T: blocking::spi::Transfer<u8, Error = E> + blocking::spi::Write<u8, Error = E>,
{
    ...
    async fn read<'a>(&'a mut self, data: &'a mut [u8]) -> Result<(), Self::Error>{
